package pers.tuershen.bladeplus.bukkit.file;

import org.bukkit.configuration.file.FileConfiguration;
import org.bukkit.configuration.file.YamlConfiguration;
import pers.tuershen.bladeplus.BladePlusMain;
import pers.tuershen.bladeplus.api.file.IBladeFile;
import pers.tuershen.bladeplus.bukkit.charset.CharsetType;
    ...
    public void reloadConfig() {
        ...
        if (defConfigStream != null) {
            YamlConfiguration defConfig = YamlConfiguration.loadConfiguration(
                    new InputStreamReader(defConfigStream, CharsetType.UTF_8));
